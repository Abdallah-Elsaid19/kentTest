...
export function CollegeCtaPanel({ id, eyebrow, title, description, actions, children }: {
  id: string;
  eyebrow: string;
  title: string;
  description?: string;
  ...
  return (
    <div className="relative isolate overflow-hidden rounded-[1.75rem] bg-[#25103F] p-7 text-white shadow-[0_24px_70px_rgba(36,13,68,0.2)] sm:p-10 lg:p-14">
      ...
      <div className={`grid ${actions ? "lg:grid-cols-[minmax(0,1fr)_340px] lg:items-end lg:gap-16" : ""}`}>
