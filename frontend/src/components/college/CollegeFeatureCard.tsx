...
export function CollegeFeatureCard({ marker, title, children, inverse = false }: {
  marker: ReactNode;
  title: string;
  children: ReactNode;
  inverse?: boolean;
