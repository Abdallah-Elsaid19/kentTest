...
export const fallbackAboutPage: ContentPage = {
  ...
  sections: [
    ...
    section(40, "aboutDomains", {
      ...
      items: [
        { id: "project-management", number: "01", initials: "PM", title: "Project Management", body: "Build practical delivery, governance, stakeholder and decision-making capability for professionals working across projects and programmes.", offerings: ["Associate Project Manager Level 4", "Workplace application and professional progression"], linkLabel: "Explore project management", href: "/college-of-project-controls-and-project-management", tone: "navy" },
        { id: "project-controls", number: "02", initials: "PC", title: "Project Controls", body: "Develop planning, cost, risk, performance and controls capability for complex project environments and evidence-led decision making.", offerings: ["Project Control Professional Level 6", "Professional pathways and applied controls practice"], linkLabel: "Explore project controls", href: "/college-of-project-controls-and-project-management", tone: "teal" },
