  ...
  return cms.render((
    <section className="relative isolate overflow-hidden bg-white py-16 sm:py-20 lg:py-28" aria-labelledby="learner-audience-title">
      <img
        ...
        src={cms.text("learners.pages_learners_components_learner_audien_learner_audience_section.src_001")}
        alt=""
        aria-hidden="true"
        loading="lazy"
        decoding="async"
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1240px] px-5 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-[900px]">
          <FigmaSectionHeading
            ...
            eyebrow={cms.text("learners.pages_learners_components_learner_audien_learner_audience_section.eyebrow_002")}
            title={cms.text("learners.pages_learners_components_learner_audien_learner_audience_section.title_003")}
            description={cms.text("learners.pages_learners_components_learner_audien_learner_audience_section.description_004")}
          />
        </div>
