      ...
      <div className="mx-auto w-full max-w-[1240px] px-5 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-[940px]">
          <FigmaSectionHeading
            ...
            eyebrow={cms.text("learners.pages_learners_components_learner_suppor_learner_support_section.eyebrow_001")}
            title={cms.text("learners.pages_learners_components_learner_suppor_learner_support_section.title_002")}
          />
        </div>
