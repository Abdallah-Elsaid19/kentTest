  ...
  return cms.render((
    <section className="relative isolate scroll-mt-40 overflow-hidden bg-kbc-purple-50 py-16 sm:py-20 lg:py-28" id="how-it-works" aria-labelledby="learner-how-title">
      <img
        ...
        src={cms.text("learners.pages_learners_components_learner_how_se_learner_how_section.src_001")}
        alt=""
        aria-hidden="true"
        loading="lazy"
        decoding="async"
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1240px] px-5 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-[900px]">
          <FigmaSectionHeading id="learner-how-title" eyebrow={cms.text("learners.pages_learners_components_learner_how_se_learner_how_section.eyebrow_002")} title={cms.text("learners.pages_learners_components_learner_how_se_learner_how_section.title_003")} />
        </div>
