...
const learnerHeroImage = "{{cms:learners.pages_learners_components_learner_hero_s_learner_hero_image.text_001}}";
    ...
    <section className="kbc-page-hero-offset relative isolate flex min-h-[100svh] flex-col overflow-hidden bg-primary pb-[clamp(16px,3svh,48px)] text-white" aria-labelledby="learner-hero-title">
      ...
      <div className="figma-shell figma-hero__grid relative z-10 !items-start sm:max-xl:!grid-cols-1">
        <div className="figma-hero__copy flex flex-col items-center text-center sm:block sm:max-xl:!mx-auto sm:max-xl:!flex sm:max-xl:!max-w-[760px] sm:max-xl:!flex-col sm:max-xl:!gap-9 sm:max-xl:!text-center xl:text-left">
          <p className="figma-hero__eyebrow !mx-auto !text-xs !font-bold !leading-5 !tracking-widest !text-[#F5C94F] [@media(max-height:1000px)_and_(max-width:639px)]:!mb-3 [@media(max-height:1000px)_and_(min-width:1280px)]:!mb-3 sm:max-xl:!mb-0 sm:max-xl:!text-[15px] xl:!ml-0 xl:!mr-0">{cms.text("learners.pages_learners_components_learner_hero_s_learner_hero_section.text_002")}</p>
          <h1 id="learner-hero-title" className="!text-5xl !font-medium !leading-none !tracking-tight !text-white sm:max-xl:!text-[clamp(68px,12vw,82px)] xl:!text-[82px]">
            {cms.text("learners.pages_learners_components_learner_hero_s_learner_hero_section.text_003")}<span className="text-[#F5C94F]">{cms.text("learners.pages_learners_components_learner_hero_s_learner_hero_section.text_004")}</span>
          </h1>
          <p className="max-w-2xl !text-base !leading-relaxed text-white/80 [@media(max-height:1000px)_and_(max-width:639px)]:!mt-4 [@media(max-height:1000px)_and_(min-width:1280px)]:!mt-4 sm:max-xl:!mt-0 sm:max-xl:!text-[27px] sm:max-xl:!leading-[1.6] xl:!text-lg">
            {cms.text("learners.pages_learners_components_learner_hero_s_learner_hero_section.text_005")}</p>

          <HeroActionButtons
            primary={{ label: cms.text("learners.pages_learners_components_learner_hero_s_label.text_006"), to: "#learner-programmes" }}
            secondary={{ label: cms.text("learners.pages_learners_components_learner_hero_s_label.text_007"), to: "/book-session" }}
