...
export function LearnerHeroSection() {
  return (
    <section className="relative isolate min-h-[100svh] overflow-hidden bg-primary text-white" aria-labelledby="learner-hero-title">
      <img
      ...
      <div className="figma-shell kbc-page-hero-offset relative z-10 flex min-h-[100svh] items-center pb-20">
        <div className="max-w-[720px]">
          <p className="figma-eyebrow !text-[#F5C94F]">For Learners</p>
          <h1 id="learner-hero-title" className="mt-5 !text-[clamp(2.5rem,13vw,3rem)] !leading-[.94] !text-white drop-shadow-[0_5px_18px_rgba(0,0,0,.75)] sm:!text-6xl lg:!text-7xl xl:!text-[78px]">
