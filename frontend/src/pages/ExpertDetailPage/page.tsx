...
export default function ExpertDetailPage() {
  ...
  return (
    <div className="kbc-figma-home overflow-hidden bg-white">
          ...
          <div className="mt-10 grid items-center gap-10 lg:grid-cols-[1fr_390px] lg:gap-20">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a className="inline-flex min-h-12 items-center gap-2 rounded-lg bg-kbc-gold-500 px-5 text-sm font-bold text-[#25102f] transition hover:-translate-y-0.5 hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#401B8C]" href={expert.linkedIn} target="_blank" rel="noreferrer"><Linkedin className="h-5 w-5" aria-hidden="true" />LinkedIn profile<ArrowUpRight className="h-4 w-4" aria-hidden="true" /></a>
      ...
      <main>
        <section className="px-5 py-20 sm:py-24 lg:py-28">
          <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[.65fr_1.35fr] lg:gap-20">
            <div>
              <p className="text-xs font-bold uppercase tracking-[.17em] text-[#401B8C]">Professional profile</p>
        ...
        <section className="bg-[#f7f4f8] px-5 py-20 sm:py-24">
          <div className="mx-auto max-w-6xl">
            <div className="max-w-3xl"><p className="text-xs font-bold uppercase tracking-[.17em] text-[#401B8C]">Areas of expertise</p><h2 className="mt-4 !text-[clamp(2.25rem,4vw,3.6rem)] !leading-tight !text-kbc-purple-950">Specialist knowledge for complex professional challenges.</h2></div>
            <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">{expert.expertise.map((item, index) => <article className="rounded-xl border border-[#401B8C]/10 bg-white p-6 shadow-[0_8px_24px_rgba(64,27,140,.07)]" key={item}><span className="text-xs font-bold text-kbc-gold-600">0{index + 1}</span><h3 className="mt-8 !text-xl !leading-7 !text-kbc-purple-950">{item}</h3></article>)}</div>
          </div>
        </section>

        <section className="px-5 py-20 sm:py-24 lg:py-28">
          <div className="mx-auto grid max-w-6xl overflow-hidden rounded-2xl border border-[#401B8C]/10 bg-white shadow-[0_18px_55px_rgba(64,27,140,.1)] lg:grid-cols-[.75fr_1.25fr]">
            <div className="bg-[#401B8C] p-8 text-white sm:p-12">
      ...
      <section className="bg-[#f7f4f8] px-5 py-20 sm:py-24">
        <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-8 rounded-2xl bg-[#401B8C] p-8 text-white sm:p-12 lg:flex-row lg:items-center">
