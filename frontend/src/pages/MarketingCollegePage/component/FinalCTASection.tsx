    ...
    <section id="marketing-cta" className="scroll-mt-40 bg-white py-16 sm:py-20 lg:py-28" aria-labelledby="marketing-cta-title">
      <div className="mx-auto w-full max-w-[1240px] px-5 sm:px-8 lg:px-10">
        <div className="relative isolate grid overflow-hidden rounded-[1.75rem] bg-[#25103F] p-7 text-white shadow-[0_24px_70px_rgba(36,13,68,0.2)] sm:p-10 lg:grid-cols-[1fr_340px] lg:items-end lg:gap-16 lg:p-14">
          ...
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#F5C94F]">{finalCta.eyebrow}</p>
            <h2 id="marketing-cta-title" className="mt-5 max-w-[760px] text-4xl font-semibold leading-[1.02] tracking-[-0.04em] text-white sm:text-5xl lg:text-6xl">{finalCta.title}</h2>
            <p className="mt-6 max-w-[720px] text-sm leading-7 text-white/65 sm:text-base">{finalCta.description}</p>
          </div>
