...
export function CapabilitiesSection() {
  return (
    <section id="marketing-capabilities" className={section} aria-labelledby="marketing-capabilities-title">
      <div className={shell}>
        <FigmaSectionHeading id="marketing-capabilities-title" eyebrow={capabilityCopy.eyebrow} title={capabilityCopy.title} description={capabilityCopy.description} />
        <div className="mt-12 grid gap-x-8 sm:grid-cols-2 lg:grid-cols-3">
          {marketingCapabilities.map(({ icon: Icon, title, desc }) => (
