...
export function OverviewSection() {
  return (
    <section id="marketing-overview" className={`${section} relative isolate overflow-hidden`} aria-labelledby="marketing-overview-title">
      <img
      ...
      <div className={`${shell} relative z-10`}>
        <div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-7">
            <FigmaSectionHeading id="marketing-overview-title" eyebrow={overview.eyebrow} title={overview.title} align="left" />
            <div className={`mt-6 space-y-4 ${muted}`}>
          ...
          <div className="overflow-hidden rounded-2xl lg:col-span-5">
            <img
              src={overview.image}
              alt="Marketing professionals learning at a Kent Business College event"
              width={1000}
              height={667}
              loading="lazy"
              decoding="async"
