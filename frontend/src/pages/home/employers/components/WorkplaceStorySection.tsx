  ...
  return (
    <section className="figma-story !py-16 sm:!py-20 xl:!py-[118px]" aria-labelledby="story-title">
      <div className="figma-shell figma-story__grid !grid-cols-1 !gap-10 lg:!grid-cols-[1.02fr_.98fr] lg:!gap-16">
        ...
        <article>
          <span className="figma-eyebrow">Learning applied at work</span>
          <h2 className="!text-4xl sm:!text-5xl xl:!text-[58px]" id="story-title">Professional theory<br />connected to real<br />marketing experience.</h2>
          <blockquote>“The apprenticeship has been really valuable in helping me connect more than ten years of hands-on experience to proper marketing theory.”</blockquote>
          <h3>Corinna Denbow</h3>
          <p>Marketing Manager at Clevertouch · Marketing Manager Level 6</p>
          <ul>
