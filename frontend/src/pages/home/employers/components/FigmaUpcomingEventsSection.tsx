...
export function FigmaUpcomingEventsSection() {
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute -left-24 top-24 size-72 rounded-full border border-primary/10" />
      <div className="pointer-events-none absolute -right-20 bottom-16 size-64 rounded-full border border-primary/10" />
      ...
      <div className="figma-shell relative">
        ...
        <div className="grid gap-5 xl:grid-cols-[1.4fr_.6fr]">
          <Link
            className="group relative grid min-h-[440px] overflow-hidden rounded-[22px] border border-primary/15 bg-white shadow-[0_20px_55px_rgba(75,23,109,0.1)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_26px_70px_rgba(75,23,109,0.16)] sm:grid-cols-2"
            to={getEventPath(featured)}
          >
            <div className="relative min-h-[260px] overflow-hidden bg-primary sm:min-h-full">
              <img
              ...
              <span className="absolute left-0 top-5 rounded-r-md bg-primary px-4 py-2 text-[10px] font-bold uppercase tracking-[0.2em] !text-white shadow-lg">
                Featured
              </span>
            </div>

            <div className="flex min-w-0 flex-col p-6 sm:p-8 lg:p-10">
              <div className="flex w-fit items-center gap-2 rounded-lg bg-primary px-3 py-2 text-[11px] font-semibold uppercase tracking-[0.12em] !text-white">
              ...
              <p className="mt-4 flex items-center gap-2 text-sm !text-primary/65">
              ...
              <span className="mt-9 inline-flex w-fit items-center gap-3 rounded-lg bg-primary px-5 py-3 text-sm font-semibold !text-white transition-colors group-hover:bg-primary-dark">
          ...
          <div className="grid gap-5 xl:grid-rows-2">
            {compactEvents.map((event) => {
              ...
              return (
                <Link
                  className="group grid min-h-[220px] grid-cols-[minmax(0,1fr)_72px] gap-5 rounded-[18px] border border-primary/15 bg-white p-5 shadow-[0_12px_35px_rgba(75,23,109,0.07)] transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:shadow-[0_20px_50px_rgba(75,23,109,0.14)] sm:p-6"
                  key={event.id}
                  to={getEventPath(event)}
                >
                  <div className="flex h-full min-w-0 flex-col">
                    <span className="w-fit rounded-md bg-primary px-2 py-1 text-[9px] font-bold uppercase tracking-[0.12em] !text-white">
                  ...
                  <div className="flex flex-col items-end justify-between">
                    <time
                      className="flex size-[58px] flex-col items-center justify-center rounded-xl bg-primary text-center shadow-sm"
                    ...
                    <span className="grid size-9 place-items-center rounded-md bg-primary !text-white transition-all duration-300 group-hover:translate-x-0.5 group-hover:bg-primary-dark">
        ...
        <div className="mt-6 flex justify-end sm:mt-8">
          <ArrowLink className="!text-sm !font-semibold !leading-5" to="/events" direction="up-right">
            View all events
          </ArrowLink>
        </div>
      </div>
