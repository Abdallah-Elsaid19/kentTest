  ...
  return (
    <section className="learner-support !py-16 sm:!py-20 xl:!py-[118px]" id="learner-support" aria-labelledby="learner-support-title">
      <div className="learner-shell">
        <LearnerSectionHeading id="learner-support-title" eyebrow="Support throughout" title="You are supported as a professional, not treated as a course number." description="KBC combines structured programme delivery with individual guidance and workplace-focused development." />
