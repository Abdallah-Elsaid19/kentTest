    ...
    <div className="kbc-figma-home overflow-hidden bg-[#f8f6fa]">
      ...
      <main className="px-5 pb-24 pt-16 sm:pt-20 lg:pb-32">
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 border-b border-[#4B176D]/10 pb-8">
            <p className="text-xs font-bold uppercase tracking-[.17em] text-[#4B176D]">Professional faculty</p>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {experts.map((expert) => (
              <article className="group flex min-h-full flex-col overflow-hidden rounded-[10px] border border-[#ddd6e2] bg-white shadow-[0_7px_20px_rgba(38,13,50,.14)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_16px_38px_rgba(75,23,109,.2)]" key={expert.id}>
                <div className="relative h-[188px] bg-[#4B176D]">
                  <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
                    ...
                    <div className="absolute inset-0 bg-[#4B176D]/65" />
                ...
                <div className="flex flex-1 flex-col px-[18px] pb-[18px] pt-[26px]">
                  ...
                  <div className="mt-auto flex items-center gap-3 pt-7">
                    <Link className="inline-flex min-h-11 flex-1 items-center justify-center gap-2 rounded-md bg-[#4B176D] px-5 text-sm font-bold text-white transition hover:-translate-y-0.5 hover:bg-[#371347] hover:shadow-[0_8px_20px_rgba(75,23,109,.24)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4B176D] focus-visible:ring-offset-2" to={`/our-experts/${expert.id}`}>View Profile<ArrowUpRight className="h-4 w-4" aria-hidden="true" /></Link>
                    <a className="grid h-11 w-11 shrink-0 place-items-center rounded-md border border-[#4B176D]/25 text-[#4B176D] transition hover:-translate-y-0.5 hover:bg-[#4B176D] hover:text-white hover:shadow-[0_8px_20px_rgba(75,23,109,.18)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4B176D] focus-visible:ring-offset-2" href={expert.linkedIn} target="_blank" rel="noreferrer" aria-label={`View ${expert.name} on LinkedIn`}><Linkedin className="h-[18px] w-[18px]" aria-hidden="true" /></a>
                  </div>
                </div>
              </article>
            ))}
      ...
      <section className="bg-white px-5 py-20 sm:py-24">
        <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-8 rounded-[24px] bg-[#4B176D] p-8 text-white shadow-[0_22px_55px_rgba(75,23,109,.2)] sm:p-12 lg:flex-row lg:items-center">
