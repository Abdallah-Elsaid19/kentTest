    ...
    <section className="scroll-mt-40 bg-[#f7f4fb] py-16 sm:py-20 lg:py-28" id="partner-with-us" aria-labelledby="employer-partner-title">
      <div className="mx-auto w-full max-w-[1240px] px-5 sm:px-8 lg:px-10">
        <div className="relative isolate grid overflow-hidden rounded-[1.75rem] bg-[#25103F] p-7 text-white shadow-[0_24px_70px_rgba(36,13,68,0.2)] sm:p-10 lg:grid-cols-[1fr_340px] lg:items-end lg:gap-16 lg:p-14">
          ...
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#F5C94F]">Partner with us</p>
            ...
            <p className="mt-6 max-w-[720px] text-sm leading-7 text-white/65 sm:text-base">
              Speak to our team about your skills needs and funding position, and we'll recommend the right workforce development plan.
            </p>
          </div>
          <div className="mt-9 grid gap-3 lg:mt-0">
            <NavigationButton className="w-full justify-between px-6" to="/contact" variant="accent">
              Speak to our team <ArrowRight className="size-4" aria-hidden="true" />
            </NavigationButton>
            <NavigationButton className="w-full justify-between px-6" to="/employer-agreement" variant="inverse">
              Employer agreement <ArrowUpRight className="size-4" aria-hidden="true" />
            </NavigationButton>
          </div>
        </div>
      </div>
