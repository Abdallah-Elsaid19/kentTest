...
export function LearnerSupportSection() {
  ...
  const cmsValues = cms.resolve({ learnerSupport, supportIcons });
      ...
      <div className="mx-auto w-full max-w-[1240px] px-5 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-[940px]">
          <FigmaSectionHeading
            ...
            eyebrow={cms.text("employers.pages_employers_components_learner_suppo_learner_support_section.eyebrow_001")}
            title={cms.text("employers.pages_employers_components_learner_suppo_learner_support_section.title_002")}
          />
        </div>

        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:mt-16 lg:grid-cols-4">
          {cmsValues.learnerSupport.map((item, index) => {
            const Icon = cmsValues.supportIcons[index];
            return (
