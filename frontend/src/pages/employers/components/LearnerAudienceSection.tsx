...
export function LearnerAudienceSection() {
  ...
  const cmsValues = cms.resolve({ learnerAudiences, audienceIcons });
  ...
  return cms.render((
    <section className="relative isolate overflow-hidden bg-white py-16 sm:py-20 lg:py-28" aria-labelledby="learner-audience-title">
      <img
        ...
        src={cms.text("employers.pages_employers_components_learner_audie_learner_audience_section.src_001")}
        alt=""
        aria-hidden="true"
        loading="lazy"
        decoding="async"
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1240px] px-5 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-[900px]">
          <FigmaSectionHeading
            ...
            eyebrow={cms.text("employers.pages_employers_components_learner_audie_learner_audience_section.eyebrow_002")}
            title={cms.text("employers.pages_employers_components_learner_audie_learner_audience_section.title_003")}
            description={cms.text("employers.pages_employers_components_learner_audie_learner_audience_section.description_004")}
          />
        </div>

        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:mt-16 lg:grid-cols-4">
          {cmsValues.learnerAudiences.map((audience, index) => {
            const Icon = cmsValues.audienceIcons[index];
            return (
