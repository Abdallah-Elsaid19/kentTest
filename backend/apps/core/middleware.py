...
class SecurityHeadersMiddleware:
    ...
    def __call__(self, request):
        ...
        response.setdefault(
            ...
            "frame-src https://challenges.cloudflare.com https://*.zoho.com https://forms.zohopublic.com "
            "https://outlook.office.com https://bookings.cloud.microsoft https://*.bookings.cloud.microsoft; "
